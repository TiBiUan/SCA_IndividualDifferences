...
boot_stats.Ub_lB = prctile(Ub_vect,0.5,3); % lower bound of 95% CI
boot_stats.Ub_uB = prctile(Ub_vect,100-(0.5),3); % upper bound of 95% CI

boot_stats.Vb_mean = mean(Vb_vect,3); % mean
boot_stats.Vb_std = std(Vb_vect,[],3); % standard deviation
boot_stats.Vb_lB = prctile(Vb_vect,0.5,3); % lower bound of 95% CI
boot_stats.Vb_uB = prctile(Vb_vect,100-(0.5),3); % upper bound of 95% CI
...
boot_stats.LC_behav_loadings_lB = prctile(boot_results.LC_behav_loadings_boot,0.5,3); % lower bound of 95% CI
boot_stats.LC_behav_loadings_uB = prctile(boot_results.LC_behav_loadings_boot,100-(0.5),3); % upper bound of 95% CI
...
boot_stats.LC_img_loadings_lB = prctile(boot_results.LC_img_loadings_boot,0.5,3); % lower bound of 95% CI
boot_stats.LC_img_loadings_uB = prctile(boot_results.LC_img_loadings_boot,100-(0.5),3); % upper bound of 95% CI
